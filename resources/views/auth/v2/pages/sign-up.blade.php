            ...
            <div class="sign-in-wrap">
                <div class="sign-in-box">
                    <div class="left">
                        <div class="content">
                            ...
                            <div class="sign-in-inner">
                                ...
                                <form class="form-login flex flex-column gap24" accept-charset="utf-8" action="{{ route('register') }}" method="POST">
                                    @csrf
                                    <fieldset class="name">
                                        <div class="f14-regular mb-6">Full name</div>
                                    ...
                                    <fieldset class="email">
                                     ...
                                     <fieldset class="name">
                                        <div class="f14-regular mb-6">Phone number</div>
                                        <input class="flex-grow" type="tel" placeholder="" name="phone" tabindex="0" value="" aria-required="true" required="">
                                         @error('phone')
                                            <div class="box-status bg-LightGray type-red">
                                                <span class="font-poppins">{{$message}}</span> 
                                            </div>
                                    ...
                                    <button class="tf-button style-1 label-01 w-100" type="submit">Sign Up</button>
                                </form>
                                <div class="f14-regular">
                                    Already have an account?
                                    <a href="/sign-in" class="f14-bold">Sign In</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="right">
                        ...
                        <div class="text">
                            <img class="mb-12" src="{{ asset('auth/images/item/sign-up.png')}}" alt="">
                            <h3 class="mb-24 text-White">Buy & sell Each Digital <br> Cryptocurrency</h3>
                            <div class="f14-regular text-White">
