...
@section('title', 'Reset Password | ApexCrypto Finance LTD')
                ...
                <div class="sign-in-box">
                    <div class="left">
                        <div class="content">
                            ...
                            <div class="sub f12-regular text-GrayDark">You're almost done!.</div>
                            <div class="sign-in-inner">
                                <h4>Reset your password</h4>
                                <form class="form-login flex flex-column gap24" accept-charset="utf-8" method="POST" action="{{ route('password.update') }}">
                                    @csrf
                                  ...
                                  <fieldset class="password">
                                        <div class="f14-regular mb-6">Confirm Password</div>
