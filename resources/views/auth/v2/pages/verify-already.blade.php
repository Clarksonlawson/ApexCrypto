...
@section('title', 'Email Already Verified | ApexCrypto Finance LTD')
...
<div class="d-flex justify-content-center align-items-center min-vh-100">
    <div class="col-lg-4 col-md-6 col-sm-10">
        <div class="wg-box style-1 gap20 bg-Gainsboro shadow-none mb-32 box-about text-center p-4 rounded-4">
            ...
            {{-- Section Title --}}
            <div class="head label-01 text-center mb-3">There's no need!</div>

            {{-- Status Section --}}
            <div class="d-flex justify-content-center mb-3">
                <div class="box-status bg-LightGray d-inline-flex align-items-center px-4 py-2 rounded">
                    <i class="icon icon-check me-2"></i>
                    <span class="font-poppins fw-bold text-dark">Email already verified</span>
                </div>
            </div>

            {{-- Description --}}
            <div class="desc f14-medium text-GrayDark text-center mb-4">
                You’ve already verified your email. You can go directly to your dashboard.
            </div>
