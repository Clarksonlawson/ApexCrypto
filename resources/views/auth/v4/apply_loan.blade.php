    ...
    <div x-data="loanApplication()" class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div
                    class="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm ring-1 ring-gray-200 dark:ring-gray-800 text-center">
            ...
            <!-- Application Form -->
            <div
                class="bg-white dark:bg-gray-900 rounded-2xl shadow-sm ring-1 ring-gray-200 dark:ring-gray-800 overflow-hidden">
                <!-- Form Header -->
                ...
                <!-- Form Content -->
                <form action="{{ route('credit.store') }}" method="post" class="p-6 space-y-6" @submit="handleSubmit">
                    @csrf
                    <!-- Loan Amount Section -->
                    <div class="space-y-4">
                        <h3
                            class="text-lg font-semibold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-800 pb-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="amount" x-model="loanAmount"
                                        @input="calculateMonthlyPayment()" required min="1000" step="100"
                            ...
                            <div>
                                ...
                                <select name="duration" x-model="duration" @change="calculateMonthlyPayment()" required
                        ...
                        <div x-show="monthlyPayment > 0" x-transition
                            ...
                            <p class="text-2xl font-bold text-blue-600 dark:text-blue-400"
                                x-text="`$${monthlyPayment.toFixed(2)}`"></p>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
                        ...
                        <div class="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle"
                                    class="w-5 h-5 text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5"></i>
                                <p>Interest rates are subject to credit assessment and may vary based on loan type and
                                    duration.</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle"
                                    class="w-5 h-5 text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5"></i>
                                <p>All loan applications are subject to approval and verification of provided information.
                                </p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle"
                        ...
                        <div class="mt-4 flex items-center gap-3">
                            ...
                            <label for="terms" class="text-sm text-gray-900 dark:text-white">
                                I accept the <a href="#"
                                    class="text-blue-600 dark:text-blue-400 hover:underline">terms and
                                    conditions</a>
                                <span class="text-red-500">*</span>
                            </label>
                        </div>
                ...
                calculateMonthlyPayment() {
                    if (this.loanAmount > 0 && this.duration > 0) {
                        ...
                        if (monthlyRate === 0) {
                            ...
                            this.monthlyPayment = this.loanAmount * (monthlyRate * Math.pow(1 + monthlyRate, numPayments)) /
