  ...
  <div class="container mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8" x-data="{
        ...
        <div class="mb-6 sm:mb-8">
          <div class="text-center">
            <div
              class="inline-flex items-center gap-2 px-3 py-1 bg-blue-600/10 text-blue-400 rounded-full text-sm font-medium mb-4">
        ...
        <div class="bg-gray-900 rounded-xl border border-gray-800 overflow-hidden">
          ...
          <div class="p-4 sm:p-6 border-b border-gray-800">
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-gray-400 text-xs sm:text-sm">Secure your account with government-issued ID verification
                </p>
              </div>
            </div>
          </div>
          ...
          <!-- Form Content -->
          <form action="{{route('verificaiton.submit')}}" method="POST"
            enctype="multipart/form-data" x-on:submit="isSubmitting = true" class="p-4 sm:p-6">
            @csrf
                  ...
                  <div class="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p class="text-blue-300 text-xs sm:text-sm">
                        Please ensure all information matches exactly with your government-issued ID. Details cannot be
            ...
            <div x-show="currentStep === 2" x-transition>
              ...
              <div class="grid grid-cols-1 gap-4 sm:gap-6">
                <div class="space-y-2">
                  ...
                  <input type="text" name="address" required placeholder="Enter your complete street address"
                    class="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none transition-all">
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div class="space-y-2">
                    ...
                    <input type="text" name="state" required placeholder="Enter your state or province"
                      class="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none transition-all">
                  </div>
                </div>
            ...
            <div x-show="currentStep === 3" x-transition>
              ...
              <div class="mb-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                  <label class="relative cursor-pointer group">
                    <input type="radio" name="document_type" value="Int'l Passport" x-model="documentType"
                      class="sr-only">
                  ...
                  <label class="relative cursor-pointer group">
                    <input type="radio" name="document_type" value="Drivers License" x-model="documentType"
                      class="sr-only">
                    <div class="p-4 rounded-xl border-2 transition-all text-center bg-gray-800 hover:bg-gray-700"
              ...
              <!-- Requirements Notice -->
              <div
                class="bg-gradient-to-r from-amber-600/10 to-orange-600/10 rounded-xl p-4 sm:p-6 mb-8 border border-amber-600/20">
                <div class="flex items-start gap-3">
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                ...
                <div class="space-y-3">
                  ...
                  <div class="relative">
                    ...
                    <div
                      class="border-2 border-dashed border-gray-600 rounded-xl p-6 text-center bg-gray-800 hover:bg-gray-750 hover:border-blue-500 transition-all">
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <p class="text-gray-400 text-sm leading-relaxed">
                Your documents are encrypted and stored securely. We use bank-level security measures to protect your
