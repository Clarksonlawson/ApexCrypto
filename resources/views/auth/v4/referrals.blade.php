...
@section('title', 'Refer a User')
@section('content')

    <div class="container mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8" x-data="{
        showCopied: false,
        showQRCode: false,
        ...
        <div class="mb-6 sm:mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="text-gray-400 text-sm sm:text-base">Grow your network and earn rewards with Remedy
                    </p>
                </div>
                <div class="flex flex-wrap gap-2">
                    ...
                    <button @click="showQRCode = !showQRCode"
                        ...
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h2M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a1 1 0 001 1zM5 20h2a1 1 0 001-1v-2a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1z">
                            </path>
                        </svg>
                        QR Code
                    </button>
            ...
            <div class="bg-gray-900 rounded-xl p-4 sm:p-6 border border-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-white text-xl sm:text-2xl font-bold mt-1"> {{ $totalReferrals }}</p>
                    </div>
                    <div class="bg-blue-600/10 p-2 sm:p-3 rounded-lg">
                        <svg class="w-5 h-5 sm:w-6 sm:h-6 text-blue-500" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="bg-gray-900 rounded-xl p-4 sm:p-6 border border-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-white text-xl sm:text-2xl font-bold mt-1">${{ number_format($earnings, 2) }}</p>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="bg-purple-600/10 p-2 sm:p-3 rounded-lg">
                        <svg class="w-5 h-5 sm:w-6 sm:h-6 text-purple-500" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9.663 17h4.673M12 3l1.168 4.312L18 8.8l-5.045 2.57L14.8 18H9.2l1.845-6.63L6 8.8l4.832-1.488L12 3z">
                            </path>
                        </svg>
                    </div>
                </div>
            ...
            <div class="bg-gray-900 rounded-xl p-4 sm:p-6 border border-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-white text-lg sm:text-xl font-bold mt-1">{{ $referrer }}</p>
                    </div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <div class="flex rounded-lg overflow-hidden">
                            ...
                            <button
                                @click="navigator.clipboard.writeText('{{ $referralLink }}'); showCopied = true; setTimeout(() => showCopied = false, 2000)"
                    ...
                    <div>
                        ...
                        <div class="bg-gray-800 border border-gray-700 rounded-lg px-4 py-3">
                            <span class="text-blue-400 font-mono text-lg">{{ Auth::user()->referral_code }}</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div class="bg-gray-800 border border-gray-700 rounded-lg p-4 text-center">
                            ...
                            <div class="inline-block">
                                {!! QrCode::size(150)->generate($referralLink) !!}
                            </div>
            ...
            <div class="border-b border-gray-800">
                <nav class="flex">
                    <button @click="selectedTab = 'overview'"
                        :class="selectedTab === 'overview' ? 'bg-blue-600 text-white' :
                    ...
                    <button @click="selectedTab = 'referrals'"
                        :class="selectedTab === 'referrals' ? 'bg-blue-600 text-white' :
                            'text-gray-400 hover:text-white hover:bg-gray-800'"
                        class="px-4 sm:px-6 py-3 sm:py-4 text-sm font-medium transition-colors duration-200">
                        My Referrals
                    </button>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="text-center">
                                    <div
                                        class="bg-blue-600/10 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3">
                                        <span class="text-blue-500 font-bold">1</span>
                                    </div>
                                    <h4 class="text-white font-medium mb-2">Share Your Link</h4>
                                    <p class="text-gray-400 text-sm">Share your unique referral link with
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-gray-400 text-sm">When someone signs up using your link, they
                                        become your referral</p>
                                </div>
                                <div class="text-center">
                                    <div
                                    ...
                                    <p class="text-gray-400 text-sm">Get commission from their trading
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center justify-between p-3 bg-gray-800 rounded-lg">
                                    <div class="flex items-center">
                                        <div
                                            class="w-8 h-8 bg-amber-600 rounded-full flex items-center justify-center mr-3">
                ...
                <div x-show="selectedTab === 'referrals'" x-transition>
                    ...
                    <div class="mb-6">
                        <div class="flex flex-col sm:flex-row gap-4">
                            <div class="flex-1">
                                <input type="text" x-model="searchQuery" placeholder="Search referrals..."
                        ...
                        <table class="w-full">
                            <thead>
                                <tr class="border-b border-gray-800">
                                    ...
                                    <th class="text-left py-3 px-4 text-gray-400 font-medium">Date Registered
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                    ...
                    <div class="lg:hidden space-y-4">
                        <div class="text-center py-12">
                            ...
                            <p class="text-gray-500 text-sm mb-4">Start sharing your referral link to build your
                                network</p>
                            <button
                                @click="navigator.clipboard.writeText('https://remedyalgotradescript.sbs/ref/Gy'); showCopied = true; setTimeout(() => showCopied = false, 2000)"
                ...
                <div class="inline-block align-bottom bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
                    ...
                    <div class="bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            <div class="w-full">
                                <h3 class="text-lg leading-6 font-medium text-white mb-4">Share Referral Program
                                </h3>
        ...
        <!-- Toast Notification -->
        <div x-show="shareToast" x-transition:enter="transition ease-out duration-300"
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('referralData', () => ({
                shareToSocial(platform) {
                    const url = 'https://remedyalgotradescript.sbs/ref/Gy';
                    const text =
                        `Join me on Remedy - The ultimate trading platform! Use my referral link to get started: `;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            if (typeof QRCode !== 'undefined') {
                QRCode.toCanvas(document.getElementById('qrcode'), 'https://remedyalgotradescript.sbs/ref/Gy', {
                    width: 150,
                    height: 150,
                    colorDark: '#000000',
                    colorLight: '#ffffff'
        ...
        function myFunction() {
            navigator.clipboard.writeText('https://remedyalgotradescript.sbs/ref/Gy').then(() => {
