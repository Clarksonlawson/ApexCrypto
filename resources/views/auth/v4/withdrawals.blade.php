        ...
        <div
            ...
            <div class="p-4 sm:p-6 lg:p-8">
                    ...
                    <div class="flex flex-col sm:flex-row">
                        ...
                        <div class="sm:ml-4 flex-1">
                            ...
                            <p class="text-xs sm:text-sm text-amber-200 leading-relaxed">
                                ...
                                <a href="mailto:Admin@apex.adabtrad.com"
                                    class="font-semibold underline hover:text-amber-100 transition-colors">Admin@apex.adabtrad.com</a>
                            ...
                            <button @click="showCodeInfo = !showCodeInfo"
                                ...
                                <span
                                    x-text="showCodeInfo ? 'Hide security details' : 'Learn about withdrawal security'"></span>
                ...
                <div class="bg-gray-800/50 rounded-xl p-4 sm:p-6 backdrop-blur-sm">
                    <form action="{{ route('withdraw.verify') }}" method="post" class="space-y-4 sm:space-y-6">
                        @csrf
                        <div>
