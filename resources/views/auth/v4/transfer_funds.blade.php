...
@section('content')
 <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
        <div class="container mx-auto px-6">
          ...
          <div class="mb-8">
            <div
              class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 max-w-md mx-auto">
          ...
          <!-- Transfer Form -->
          <div
            class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 max-w-2xl mx-auto p-6 md:p-8">
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  <input type="text" name="email" id="email"
                    ...
                    placeholder="Enter recipient's email or username" required>
                </div>
              </div>
                ...
                <div class="flex items-start">
                  ...
                  <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-blue-700 dark:text-blue-400">
                      <p>Transfer fee: <span class="font-semibold">0%</span></p>
                    </div>
                  </div>
                </div>
              </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
              ...
              .then(data => {
                if (data.status === 200) {
                  Swal.fire({
                    ...
                    window.location.href = "{{route('transfer.send')}}";
                  });
                } else {
      ...
      document.getElementById('amount').addEventListener('input', function () {
        ...
        if (feeInfo) {
          feeInfo.innerHTML = `
                        <p>Transfer fee: <span class="font-semibold">${feePercentage}%</span> (${feeAmount} $)</p>
                        <p class="mt-1">Recipient will receive: <span class="font-semibold">${netAmount} $</span></p>
                    `;
        }
      });
    });
