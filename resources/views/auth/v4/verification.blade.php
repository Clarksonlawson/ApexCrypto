        ...
        <div class="bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800">
            <div class="max-w-4xl mx-auto px-6 py-8">
                <div class="text-center">
                    <div
                        class="inline-flex items-center gap-2 px-3 py-1 bg-yellow-50 dark:bg-yellow-900/20 text-yellow-700 dark:text-yellow-300 rounded-full text-sm font-medium mb-4">
        ...
        <div class="max-w-4xl mx-auto px-6 py-8">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-lg border border-gray-100 dark:border-gray-800 mb-6"
                ...
                <div class="p-6 text-center">
                    <!-- Icon -->
                    <div
                        class="w-16 h-16 bg-yellow-50 dark:bg-yellow-900/20 rounded-full flex items-center justify-center mx-auto mb-4">
                        <svg class="w-8 h-8 text-yellow-600 dark:text-yellow-400" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                    ...
                    <div class="flex flex-col items-center gap-4">
                        <a href="{{route('kyc.form')}}" target="_blank"
                        ...
                        <button @click="showDetails = !showDetails"
                            ...
                            <svg class="w-4 h-4 inline ml-1 transition-transform" :class="showDetails ? 'rotate-180' : ''"
                    ...
                    <div x-show="showDetails" x-transition
                        class="mt-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg text-left">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-3">
                                <div class="flex items-start gap-3">
                                    <div
                                        class="w-6 h-6 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                                    ...
                                    <div>
                                        <h4 class="font-medium text-gray-900 dark:text-white text-sm">Security & Compliance
                                        </h4>
                                        <p class="text-xs text-gray-600 dark:text-gray-400">Ensures platform security and
                                            regulatory
                                            compliance</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-3">
                                    <div
                                        class="w-6 h-6 bg-green-100 dark:bg-green-900/30 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                                        <svg class="w-3 h-3 text-green-600 dark:text-green-400" fill="currentColor"
                                            viewBox="0 0 20 20">
                                            <path fill-rule="evenodd"
                                    ...
                                    <div>
                                        <h4 class="font-medium text-gray-900 dark:text-white text-sm">Identity Protection
                                        </h4>
                                        <p class="text-xs text-gray-600 dark:text-gray-400">Protects your identity and
                                            prevents fraud
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="space-y-3">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-600 dark:text-gray-400">Unlock all trading and
                                            investment features
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-3">
                                    <div
                                        class="w-6 h-6 bg-orange-100 dark:bg-orange-900/30 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-600 dark:text-gray-400">Simple 3-step verification
                                            process</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="p-6">
                    <div class="flex flex-col lg:flex-row items-center gap-6">
                        ...
                        <div class="flex-shrink-0">
                            <div
                                class="w-12 h-12 bg-blue-50 dark:bg-blue-900/20 rounded-full flex items-center justify-center">
                        ...
                        <div class="flex-1 text-center lg:text-left">
                            ...
                            <!-- Support Features -->
                            <div
                                class="flex flex-wrap gap-4 justify-center lg:justify-start text-sm text-gray-500 dark:text-gray-400">
