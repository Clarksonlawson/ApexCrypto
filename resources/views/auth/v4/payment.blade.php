        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-lg text-gray-300 max-w-2xl mx-auto">
                    Securely deposit funds using <span class="text-blue-400 font-semibold">Bank Transfer</span>
            ...
            <div class="flex items-center justify-center mb-8 sm:mb-12 overflow-x-auto pb-4">
                <div class="flex items-center space-x-2 sm:space-x-4 lg:space-x-8 min-w-max">
                    <div class="flex items-center">
                        ...
                        <span class="ml-2 sm:ml-3 text-xs sm:text-sm font-medium text-blue-400 hidden sm:inline">Payment
                            Method</span>
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="ml-2 sm:ml-3 text-xs sm:text-sm font-medium text-white hidden sm:inline">Send
                            Payment</span>
                    ...
                    <div class="flex items-center">
                        ...
                        <span
                            class="ml-2 sm:ml-3 text-xs sm:text-sm font-medium text-gray-400 hidden sm:inline">Confirmation</span>
                        <span class="ml-2 text-xs font-medium text-gray-400 sm:hidden">Confirm</span>
                    </div>
                </div>
            </div>

            <form method="POST" enctype="multipart/form-data" action="{{ route('deposit.store') }}" class="space-y-8">
                @csrf
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-3 sm:gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm sm:text-base text-gray-400">{{ $payment_method }} Deposit</p>
                                </div>
                            </div>
                    ...
                    <div class="p-4 sm:p-6 space-y-6 sm:space-y-8">
                            ...
                            <div
                                ...
                                <div class="text-center">
                                    ...
                                    <div
                                        ...
                                        <span class="text-xs sm:text-sm text-amber-300">Send exact amount to avoid
                                            delays</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bg-gray-800/30 rounded-2xl p-4 sm:p-6 border border-gray-700">
                            <div class="flex items-start gap-3 sm:gap-4">
                                <div
                                    class="w-8 h-8 sm:w-10 sm:h-10 bg-blue-500/20 rounded-full flex items-center justify-center flex-shrink-0">
                                    <i data-lucide="info" class="w-4 h-4 sm:w-5 sm:h-5 text-blue-400"></i>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <h3 class="text-base sm:text-lg font-semibold text-white mb-3">How to Complete Your
                                        Payment</h3>
                                    <div class="space-y-4 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4">
                                        <div class="flex items-start gap-3">
                                            <div
                                                class="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0">
                                                1</div>
                                            <div class="min-w-0">
                                                ...
                                                <p class="text-xs sm:text-sm text-gray-400 break-words">Transfer
                                                    {{ number_format($amount, 2) }}$ to the wallet
                                                    address</p>
                                            </div>
                                        </div>
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div class="min-w-0">
                                                ...
                                                <p class="text-xs sm:text-sm text-gray-400">Take a screenshot of your
                                                    transaction</p>
                                            </div>
                                        </div>
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div class="min-w-0">
                                                ...
                                                <p class="text-xs sm:text-sm text-gray-400">Submit proof and wait for
                                                    confirmation</p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="space-y-6 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-8">
                            ...
                            @if ($payment_method !== 'Bank Transfer')
                                ...
                                <div class="space-y-4 sm:space-y-6">
                                    ...
                                    <div class="bg-white p-4 sm:p-6 rounded-2xl">
                                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=250x250&data={{ $wallet_address }}"
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex">
                                        <input type="text" value="{{ $wallet_address }}"
                                            class="w-full bg-gray-800 border border-gray-700 rounded-l-xl px-4 py-3 text-white text-sm"
                                            readonly>

                                        <button type="button"
                                            onclick="navigator.clipboard.writeText('{{ $wallet_address }}')"
                                            class="px-4 py-3 bg-blue-600 hover:bg-blue-700 rounded-r-xl text-white">
                                            Copy
                                        </button>
                                    </div>
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <div class="relative">
                                            <input type="file" id="proof" name="proof" accept="image/*"
                                                required class="hidden" @change="handleFileUpload($event)">
                                            ...
                                            <label for="proof"
                                                ...
                                                <div class="space-y-3 sm:space-y-4">
                                                    <div
                                                        class="w-12 h-12 sm:w-16 sm:h-16 bg-blue-500/20 rounded-full flex items-center justify-center mx-auto group-hover:bg-blue-500/30 transition-colors duration-200">
                                                        <i data-lucide="upload-cloud"
                                                            class="w-6 h-6 sm:w-8 sm:h-8 text-blue-400"></i>
                                                    </div>

                                                    <div x-show="!fileName">
                                                        <p class="text-sm sm:text-lg font-medium text-white">Choose file or
                                                            drag & drop</p>
                                                        <p class="text-xs sm:text-sm text-gray-400">PNG, JPG, GIF up to
                                                            10MB
                                                        </p>
                                                    </div>

                                                    <div x-show="fileName" class="text-center">
                                                        <p class="text-sm sm:text-lg font-medium text-white break-all"
                                                            x-text="fileName"></p>
                            ...
                            @if ($payment_method == 'Bank Transfer')
                                <div class="space-y-4 sm:space-y-6">
                                    ...
                                    <div class="bg-gray-800 rounded-xl p-6 space-y-4 text-sm">

                                        <div>
                                            <p class="text-gray-400">Bank Name</p>
                                            <p class="text-white font-medium">{{ $bank_name }}</p>
                                        </div>

                                        <div>
                                            <p class="text-gray-400">Account Number</p>
                                            <p class="text-white font-medium">{{ $bank_account }}</p>
                                        </div>

                                        <div>
                                            <p class="text-gray-400">Account Holder</p>
                                            <p class="text-white font-medium">{{ $bank_holder }}</p>
                                        </div>

                                    </div>

                                    <p class="text-xs text-gray-400">
                                        Transfer the exact amount and upload proof of payment below.
                                    </p>
                                        ...
                                        <label for="proof"
                                            ...
                                            <div class="space-y-3 sm:space-y-4">
                                                ...
                                                <div x-show="!fileName">
                                                    <p class="text-sm sm:text-lg font-medium text-white">Choose file or
                                                        drag & drop</p>
                                                    <p class="text-xs sm:text-sm text-gray-400">PNG, JPG, GIF up to 10MB
                                                    </p>
                                                </div>
                        ...
                        <div class="pt-4 sm:pt-6">
                            <button type="submit" :disabled="!fileName" class="w-full relative group overflow-hidden"
                                :class="!fileName ? 'opacity-50 cursor-not-allowed' : 'hover:scale-[1.02] active:scale-[0.98]'">
                                <div
                                    class="absolute inset-0 bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl blur-lg opacity-50 group-hover:opacity-75 transition-opacity duration-200">
                                </div>
                                <div
                                    class="relative bg-gradient-to-r from-green-600 to-emerald-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-2xl flex items-center justify-center gap-2 sm:gap-3 transition-all duration-200">
                            ...
                            <!-- Security Notice -->
                            <div
                                class="mt-4 sm:mt-6 flex items-center justify-center gap-2 sm:gap-3 text-xs sm:text-sm text-gray-400">
            ...
            <div class="mt-8 sm:mt-12 grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                <div class="bg-gray-900 rounded-xl p-4 sm:p-6 border border-gray-800 text-center">
                    <div
                        class="w-10 h-10 sm:w-12 sm:h-12 bg-blue-500/20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                    ...
                    <p class="text-gray-400 text-xs sm:text-sm">Need help? Our support team is available around the clock
                    </p>
                </div>

                <div class="bg-gray-900 rounded-xl p-4 sm:p-6 border border-gray-800 text-center">
                    <div
                        class="w-10 h-10 sm:w-12 sm:h-12 bg-green-500/20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                ...
                <div class="bg-gray-900 rounded-xl p-4 sm:p-6 border border-gray-800 text-center md:col-span-1">
                    <div
                        class="w-10 h-10 sm:w-12 sm:h-12 bg-purple-500/20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                    ...
                    <p class="text-gray-400 text-xs sm:text-sm">Your funds and data are protected with enterprise security
                    </p>
                </div>
            </div>
        </div>
